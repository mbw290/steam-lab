...
const first_videos = [
  {
    ...
    thumbnail: Bubbles,
    title: 'Bubbles',
    description: 'Are bubbles always round? Explore different ways to create a bubble.'
  },
  {
    id: "first-2",
    thumbnail: Creature,
    title: 'Create a Creature',
    description: 'Have fun creating a new creature that uses its parts to survive and grow.'
  },
  {
    id: "first-3",
    thumbnail: Butterfly,
    title: 'Butterfly Life-cycle',
    description: "Create a model to illustrate the steps in a butterfly's life cycle."
  },
  {
    id: "first-4",
    thumbnail: Moon,
    title: 'Phases of the Moon',
    description: 'Use Oreos to explore the patterns of the moon in the night sky.'
  },
  {
    id: "first-5",
    thumbnail: Telephone,
...
const second_videos = [
  {
    ...
    title: "Frog's Tongue",
    description: 'Have you wondered how a frog catches a fly? Find out in this exploration.'
  },
  {
    id: "second-2",
    thumbnail: MarshmallowLauncher,
    title: 'Marshmallow Launcher',
    description: 'Create a launcher and see how far you can make your marshmallow fly.'
  },
  {
    id: "second-3",
    thumbnail: Harmonica,
  ...
  },
  {
    ...
    thumbnail: Landforms,
    title: 'Landforms',
    description: 'Do you live in the mountains, or in a valley, or along the coast? Design and create your own island.'
  },
  {
    id: "second-5",
    thumbnail: Ooblek,
  ...
  },
  {
    ...
    description: 'Bees are amazing! Explore how they pollinate the flowers around us.'
  }
]
...
const third_videos = [
  ...
  },
  {
    ...
    thumbnail: ZipLine,
    title: 'Zip Line',
    description: 'Design a zip line carrier that will protect your ping pong ball from a fall.'
  },
  {
    id: "third-3",
  ...
  },
  {
    ...
    thumbnail: BirdBeaks,
    title: 'Bird Beaks',
    description: "Why do birds have different shaped beaks? Let's think about their dinner!"
  }
]
...
const fourth_videos = [
  ...
  },
  {
    ...
    title: "Lemon Volcano",
    description: 'Explore the chemistry of lemons to create a volcano and learn about acids and bases.'
  },
  {
    id: "fourth-5",
    thumbnail: WindCar,
  ...
  },
  {
    ...
    description: "Learn about Newton's Laws with these experiments using pennies."
  }
]
...
const fifth_videos = [
  {
    ...
    description: 'Oil spills are an environmental disaster. Explore how to clean up the mess!'
  },
  {
    id: "fifth-2",
    thumbnail: CandyChemistry,
    title: 'Candy Chemistry',
    description: 'Explore a little chemistry with some of your favorite candies!'
  },
  {
    id: "fifth-3",
    thumbnail: EggDrop,
    title: "Egg Drop",
    description: 'Can you design and create a contraption to keep your egg safe from gravity?'
  },
  {
    id: "fifth-4",
    thumbnail: Osmosis,
  ...
  },
  {
    ...
    description: 'What makes a tower strong? Explore this concept by using spaghetti to build your own tower.'
  },
  {
    id: "fifth-6",
    thumbnail: Crysals,
    title: "Crystal Formation",
    description: 'Explore crystals with magnesium sulfate and create beautiful crystals of your own.'
  }
]
...
const sixth_videos = [
  ...
  },
  {
    ...
    description: 'Explore different types of bridges and build the strongest bridge ever.'
  },
  {
    id: "sixth-4",
    thumbnail: CellPhone,
    title: "Design a Cell Phone Stand",
    description: 'Can you engineer a super efficient way to hold your mobile phone?'
  },
  {
    id: "sixth-5",
